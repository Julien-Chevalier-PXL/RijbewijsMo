...
<div class="fb-login-button" data-max-rows="2" data-size="large" data-button-type="continue_with" data-show-faces="true"
     data-auto-logout-link="true" data-use-continue-as="true"></div>
            ...
            <div class="row ">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4  col-xs-5 ">
                    <a href="WelkomPagina.html" class=" btn btn-default submit-btn">Verzenden<span class="glyphicon glyphicon-log-in"></span> </a>
                </div>
            </div>
        </div>
